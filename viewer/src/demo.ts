...
export const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: "Then tools, carts, and materials drift from it. These issues imperceptibly build up over time and mount to increased production times and lost output. Atlas measures the drift from the standard every month, for everything on the floor.",
  },
  {
    title: "FUNDAMENTALS",
